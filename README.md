# Pratique UC (PROGRAMAÇÃO DE SOLUÇÕES COMPUTACIONAIS)
...
Nesta atividade tentei aplicar boas práticas de código em java
ainda não domino totalmente o gerenciamento de classes, porem sinto que houve uma grande melhora na minha base de POO,
tive muita dificuldade de estruturar a logica, voltei para o enunciado várias vezes para entender melhor e cheguei
a esse resultado, ainda tenho muito para práticar porem está unidade curricular está bem completa de conteudo e
estou tendo muito suporte dos orientadores.

## Contato

Email: alucasm02@gmail.com
Linkedin: https://www.linkedin.com/in/anderson-medeiros-dev/
